...
describe("MerkleTree Construct", function () {
    ...
    it("verify the second leaf with the inclusion proof", async () => {
        await merkleTree.insertLeaf(1);
        await merkleTree.insertLeaf(2);
    ...
    it("Insert leaves 3 and 4 and verify the first leaf in an inclusion proof", async function () {
        await merkleTree.insertLeaf(1);
        await merkleTree.insertLeaf(2);
